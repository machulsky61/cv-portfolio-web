      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p 
              className="text-base md:text-lg lg:text-xl text-muted-foreground/80 mb-8"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="relative w-80 h-80 lg:w-96 lg:h-96">
              ...
              <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-border shadow-2xl bg-gradient-to-br from-primary/20 to-secondary/20">
                {/* Placeholder for now - you can replace with your photo */}
              ...
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-secondary/30 rounded-full blur-xl animate-pulse delay-1000"></div>
            </div>
          </motion.div>
        </div>
